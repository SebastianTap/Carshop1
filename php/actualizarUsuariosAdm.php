...
<!---Barra de nav-->
      ...
      <nav id="menuprincipal">
        ...
        <br>
        <br>
        <h3 class="centrar" >Actualizar Usuarios</h3>
        ...
        <table  class="table table-dark table-striped-columns">
            ...
            <tbody>
                ...
                <tr>
                    <div>
                        <th><?=$row['id']  ?></th>
                        <th><?=$row['nombre'], $row['apellidoP'], $row['apellidoM']  ?></th>
                        <th><?=$row['correo']  ?></th>
                        ...
                        <th>
                            <a class="btn btn-outline-danger" href="eliminarUsuarioAdm.php?id=<?= $row['id']?>">
