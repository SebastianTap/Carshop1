...
<html lang="en">
    ...
    <body>
      ...
      <nav id="menuprincipal">
        ...
        <div class="centrar">
            <form action="insertarModeloAdm.php" method="POST">
                <h3>Selecciona Marca</h3>
                <select name="id" id="">
                   <?php
                   include "llenarModelo.php";
                   $mo= new Modelo();
                   $mo-> llenarListaMarca();
                   ?>
                </select>
                <h3>Agregar nuevo modelo</h3>
                <input type="text" name="modeloA" placeholder="Modelo" required>

                <input type="submit" value="Agregar modelo">
            </form>
            <br>
            ...
            <tbody>
                ...
                <tr>
                    <div>
                        ...
                        <th>
                            <a class="btn btn-primary" href="modificarModelo.php?id_M=<?= $row['id_M']?>">
