                        ...
                        <div id="columna3">
                            ...
                            include 'usuario.php';
                                ...
                                switch ($_REQUEST['opcion']){
                                    case 1:
                                        $usu -> inicializar( $_REQUEST['nombre'], $_REQUEST['apellidoP'], $_REQUEST['apellidoM'], $_REQUEST['correo'], $_REQUEST['contrasena'], $_REQUEST['telefono'], $_REQUEST['direccion']);
                                        //$usu -> insertar();
                                        break;
                                    case 4:
                            ...
                            ?>
                            <br><br>
                            <button class="botona"><a href="../html/inicioSesion.html">INICIAR SESION</a></button></div>
                       </div>
                    </section> 
                </form>
                </div>
